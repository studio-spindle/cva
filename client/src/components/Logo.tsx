...
const Logo: FC<LogoProps> = ({ white }) => {
  ...
  return (
    <Grid className={`${classes.logoContainer} ${white && classes.logoWhite}`} direction="row" container>
      <Grid item>
        <svg className={classes.logo} xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 1121.54 482.21" role="img" aria-labelledby="logoID">
